...
(function($){
	...
	*/
	...
	Photo Gallery
	*/
	$( '#gallery' ).find('a').colorbox({opacity: 0.5 , rel:'gal'});
	/*
	===============================================
	Login
	*/
		...
		$.ajax({
			...
			success: function (response) {
				...
				for(var i=0, j=response.projects.length; i < j; i++){
					...
					$(".projects").append(
						'<div id="sortable" class="ui-state-default">' + " <input class='projectid' type='hidden' value=' " + result.id + " '>" + " Project Name: " + result.projectName + "<br>" + " Project Description: " + result.projectDescription + "<br>" + " Project Status: " + result.status + "<br>" + '<button class="deletebtn">Delete</button>' + '<button class="editbtn">Edit</button>' + '</div> <br>'
					);
				};
				...
				$('.update').on('click', function (e) {
					e.preventDefault();
					var pid2 = $(this).parent().find(".projectid").val();
					$.ajax({
